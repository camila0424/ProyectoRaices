                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="md:hidden flex items-center gap-2">
                        <button
                            ...
                            className="w-9 h-9 flex items-center justify-center rounded-full border border-white/20 hover:bg-white/10 transition text-base"
                        >
                            {isDark ? "☀️" : "🌙"}
                        </button>
                        <button
                            className="flex flex-col justify-center items-center w-9 h-9 gap-1.5 rounded-md hover:bg-white/10"
